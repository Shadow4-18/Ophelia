...
No project linter config or automated test suite in-repo. Sanity check: `python3 -m compileall -q src/ophelia`.
...
- Consciousness ticks compete for the model gate; pause via UI API `POST /api/consciousness/pause` when debugging chat.
