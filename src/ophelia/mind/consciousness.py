...
class ConsciousnessLoop:
    ...
    async def _tick(self, idle_seconds: float) -> None:
        ...
        raw = await self.agent.run_consciousness_tick(
            ...
            user_text=(
                "[Autonomous consciousness tick — generated by your own runtime, "
                "NOT a message from the user. The user is not talking to you right "
                "now and did not send this.] Turn inward: read your drives, goals, "
                "mood, and body, then decide on your own what to do "
